...
public class IndustrySpecialtyConfiguration : IEntityTypeConfiguration<IndustrySpecialty>
{
    public void Configure(EntityTypeBuilder<IndustrySpecialty> builder)
    {
        ...
        builder.Property(_ => _.IndustrySubSectorId).IsRequired(true);

        builder.Property(_ => _.Name).HasColumnType("varchar(100)");
        builder.Property(_ => _.Name).IsRequired(true);

        builder
            .HasOne<IndustrySubSector>()
            .WithMany()
            .HasForeignKey(e => new { e.Version, e.IndustrySubSectorId })
            .IsRequired();
    }
}
