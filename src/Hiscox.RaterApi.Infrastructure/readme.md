### Hiscox.RaterApi.Infrastructure
...
1. Create a database in SQL Server called RaterApi, using SSMS.
1. Delete the Migrations folder
1. Open the Nuget Package Manger Console in Visual Studio.
1. Change directory to the Infrastructure project: `cd c:\repos\Hiscox.RaterApi\src\Hiscox.RaterApi.Infrastructure`
1. Set the startup project to Hiscox.RaterApi.Infrastructure 
1. Set the default project in Nuget Package Manger Console to Hiscox.RaterApi.Infrastructure
1. Run this command: `Add-Migration Create_Database`
1. Run this command: `dotnet ef database update --project Hiscox.RaterApi.Infrastructure.csproj --connection "Data Source=(local);Initial Catalog=RaterApi;Integrated Security=True;Trust Server Certificate=True"`
1. After running the commands above, change the the default project back to Hiscox.RaterApi.Aspire.AppHost.
